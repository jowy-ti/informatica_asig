...
QT_MOC_LITERAL(1, 13, 11), // "enviarTexto"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 10), // "Start_Cont"
QT_MOC_LITERAL(4, 37, 9), // "Stop_Cont"
QT_MOC_LITERAL(5, 47, 12), // "Restart_Cont"
QT_MOC_LITERAL(6, 60, 7) // "TimeOut"

    },
    "MyQLCDNumber\0enviarTexto\0\0Start_Cont\0"
    "Stop_Cont\0Restart_Cont\0TimeOut"
};
...
void MyQLCDNumber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->Start_Cont(); break;
        case 2: _t->Stop_Cont(); break;
        case 3: _t->Restart_Cont(); break;
        ...
        {
            using _t = void (MyQLCDNumber::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQLCDNumber::enviarTexto)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyQLCDNumber::enviarTexto(const QString & _t1)
{
